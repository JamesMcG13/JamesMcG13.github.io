...
function Intro(){
    return (
        <div className="flex items-center justify center flex-col text-center pt-20 pb-40">
            <h1 className="text-4xl md:text-6xl mb-2 md:mb-3 font-bold bg-clip-text text-stone-900">James McGowan</h1>
            <Typed className="text-base md:text-3xl mb-6 font-medium text-stone-900"
                strings={["Computer Science Graduate", "Software Engineer", "Data Scientist", "Web Developer", "Data Analyst"]}
                typeSpeed={120}
                backspeed={100}
                loop
            />
            <p className="text-md max-w-screen-xl font-bold md:text-1xl text-stone-900">
